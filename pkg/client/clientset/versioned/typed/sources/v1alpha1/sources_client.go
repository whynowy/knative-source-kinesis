...
import (
	...
	"github.com/whynowy/knative-source-kinesis/pkg/client/clientset/versioned/scheme"
...
func (c *SourcesV1alpha1Client) KinesisSources(namespace string) KinesisSourceInterface {
